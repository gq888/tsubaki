...
<div class="btns">
  ...
  <div class="row">
    <div calss="center">
      <ul class="cardsul" style="padding-left: 0; max-width: 500px; margin: 10px auto; justify-content: flex-start;">
        ...
        <li class="cards m-0 rela" style="width:50%; height: 150px" @click="hitflag && lockflag && clickCard(1)" :style="{zIndex: dragItem == 1 ? 11 : 'auto'}"
         @mouseenter="enter(1)" @touchenter="enter(1)" @mouseleave="leave(1)" @touchleave="leave(1)">
      ...
      <ul class="cardsul" style="padding-left: 0; max-width: 500px; margin: 10px auto; justify-content: space-between;">
      ...
      <ul class="cardsul" style="padding-left: 0; max-width: 500px; margin: 10px auto; justify-content: space-between;">
        <li v-for="i in 4" :key="i" class="cards m-0 rela" style="width:25%"
